...
export default function ProcessShowcase() {
  ...
  useEffect(() => {
    const unsubscribe = scrollYProgress.on("change", (progress) => {
      // Create more granular step progression - each step takes 25% of scroll
  ...
  return (
    <section ref={containerRef} className="min-h-[400vh] bg-slate-900 overflow-hidden relative">
