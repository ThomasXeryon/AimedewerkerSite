      ...
      <div className="min-h-screen text-white">
        ...
        <main className="relative">
          <div className="min-h-[200vh]">
            <ParallaxSection speed={1.2} offset={["start start", "end center"]}>
          ...
          <div className="min-h-[300vh]">
            <ParallaxSection speed={0.8} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
                <section id="features" className="w-full py-20 bg-slate-800/50">
          ...
          <div className="min-h-[400vh]">
            <ParallaxSection speed={1.5} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
          ...
          <div className="min-h-[500vh]">
            <ParallaxSection speed={0.9} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
                <ProcessShowcase />
              </div>
            </ParallaxSection>
          ...
          <div className="min-h-[250vh]">
            <ParallaxSection speed={1.1} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
                <section className="w-full py-20 bg-slate-800/50">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
          ...
          <div className="min-h-[200vh]">
            <ParallaxSection speed={0.7} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
                <Testimonials />
              </div>
            </ParallaxSection>
          ...
          <div className="min-h-[250vh]">
            <ParallaxSection speed={1.3} offset={["start end", "end start"]}>
              <div className="sticky top-0 min-h-screen flex items-center">
