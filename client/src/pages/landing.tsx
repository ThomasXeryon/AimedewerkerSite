    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600">Reclaim 20+ hours per week from routine tasks</p>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 gradient-bg rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p className="text-gray-600">Focus on strategic work that drives results</p>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 gradient-bg rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p className="text-gray-600">Reduce stress and improve work-life balance</p>
                  </div>
                </div>
              </div>
              
              <div className="relative">
                <div className="flank-card rounded-3xl p-8 max-w-md mx-auto border-l-4 border-blue-500">
                  <div className="text-center">
                    ...
                    <p className="text-gray-900 font-semibold text-lg mb-2">AI-Powered Professional</p>
                    <p className="text-sm text-gray-600">Focused on high-value work</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Built for Every Industry</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">From legal to sales to customer support, AI Coworker adapts to your industry's unique needs.</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center flank-card rounded-2xl p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Legal Professionals</h3>
                <p className="text-gray-600">Automate document review, case summarization, and client communication to focus on legal strategy.</p>
              </div>
              ...
              <div className="text-center flank-card rounded-2xl p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Sales Teams</h3>
                <p className="text-gray-600">Streamline lead qualification, proposal generation, and follow-up sequences to close more deals.</p>
              </div>
              ...
              <div className="text-center flank-card rounded-2xl p-8">
                ...
                <p className="text-gray-600">Enhance response times with intelligent ticket routing and automated resolution suggestions.</p>
              </div>
            </div>
          </div>
        </section>
